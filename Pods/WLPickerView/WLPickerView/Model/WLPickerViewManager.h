...
+ (WLPickerViewManager *_Nonnull)shareManger;

@property (nonatomic, strong) WLDatePickerView * _Nonnull datePicker;

@property (nonatomic, strong) WLPickerView * _Nonnull pickView;

@property (nonatomic, strong) WLAddressPickerView * _Nonnull addressPicker;
